...
<%@page import="profile.DeveloperProfile"%>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8">
				...
				%>
				<%
					Developer user = (Developer) session.getAttribute("currentSessionUser");
				%>
				<%
					DeveloperProfile devPro = ProfileDao.giveMeDevProfile(user);
				%>
				<h2>
					<%=devPro.getName()%>
				</h2>
				...
				<p></p>
				<p>
					<a href="https://github.com/ProjectMedelin/ProjectMedellin"
						class="btn btn-default btn-lg"><i class="fa fa-github fa-fw"></i>
						<span class="network-name"></span></a> <a
						href="https://github.com/ProjectMedelin/ProjectMedellin"
						class="btn btn-default btn-lg"><i class="fa fa-globe"></i> <span
						class="network-name">website</span></a> <a
						href="https://github.com/ProjectMedelin/ProjectMedellin"
						class="btn btn-default btn-lg"><i class="fa fa-linkedin fa-fw"></i>
						<span class="network-name"></span></a> <a
						href="https://github.com/ProjectMedelin/ProjectMedellin"
						class="btn btn-default btn-lg"><i class="fa fa-youtube-play"
						aria-hidden="true"></i></i> <span class="network-name"></span></a> <a
						href="https://github.com/ProjectMedelin/ProjectMedellin"
						class="btn btn-default btn-lg"><i class="fa fa-download"
						aria-hidden="true"></i> <span class="network-name"></span>CV</a>
				</p>
